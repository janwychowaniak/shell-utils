...
| `jw_functions__files.sh` | Filesystem oversight cockpit — read-only orientation/profiling (size, recency, tree, search, posture, hygiene) + backup/trash, oversight-first (`jwfiles_*`) |
